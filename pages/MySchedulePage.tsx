...
const MySchedulePage: React.FC = () => {
    const { loggedInTrainer: trainer, bookings, getCustomer, getClassType, now } = useStudioData();
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-3xl font-bold text-gray-800">My Schedule</h2>
                             <p className="text-md text-gray-500">Your weekly availability and bookings</p>
                        </div>
                    </div>
